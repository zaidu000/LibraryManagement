        ...
        <div class="container" style="max-width: 600px; margin-top: 40px;">
            ...
            <form action="RegisterServlet" method="post" autocomplete="off" onsubmit="return validateForm();">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="address" name="address" class="form-control" required readonly onfocus="this.removeAttribute('readonly');">
                </div>

                <div class="mb-3">
                    <label for="libraryName" class="form-label">Library Name:</label>
                    <input type="text" id="libraryName" name="libraryName" class="form-control" required readonly onfocus="this.removeAttribute('readonly');">
                </div>
